...
public class ChestBonus extends AbstractBonus{

    public ChestBonus(GameController gc) {
        this.position = new Vector2(0, 0);
        this.texture = Assets.getInstance().getAtlas().findRegion("chest");
        this.bonusArea = new Circle(position, 24);
        this.nameBonus = "chest";
        this.active = false;
        this.gc = gc;
